"""
L1 Instruction Cache Diagnostic Generator
...
"""
    ...
    code_name = f"{code_gen_dir}/l1_icache.{window_size}.{num_entries}.s"
    bin_name = f"{bin_dir}/l1_icache.{window_size}.{num_entries}.diag"
    template_file = f"templates/l1_icache.cpp"
