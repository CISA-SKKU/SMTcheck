...
"""
    ...
    code_name = f"{code_gen_dir}/l1_itlb-amd.{window_size}.{num_entries}.s"
    bin_name = f"{bin_dir}/l1_itlb-amd.{window_size}.{num_entries}.diag"
    template_file = f"templates/l1_itlb-amd.cpp"
...
if __name__ == "__main__":
    entire_working_set_size = (1<<17) # 128KB
    min_num_entries = 8
