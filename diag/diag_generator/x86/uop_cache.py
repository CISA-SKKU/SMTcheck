...
"""
    ...
    code_name = f"{code_gen_dir}/uop_cache.{window_size}.{num_entries}.s"
    bin_name = f"{bin_dir}/uop_cache.{window_size}.{num_entries}.diag"
    template_file = f"templates/uop_cache.cpp"
