# Integer Issue Queue Analysis

This document presents the reverse-engineering results for the integer issue queue.
...
- Based on these results, the integer issue queue has a total size of **97 entries** with a watermark size of **7 entries**.