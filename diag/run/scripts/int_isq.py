"""
Integer Issue Queue (INT ISQ) Diagnostic Runner

Runs the integer issue queue diagnostics and measures IPC.
The diagnostics fill the integer issue queue with varying numbers of
...
Usage:
    python int_isq.py <bin_dir> <output_dir> <core_id>[,<sibling_core_id>]
