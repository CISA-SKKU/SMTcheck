"""
Micro-op Cache (µop Cache) Diagnostic Runner - AMD Specific

Runs the micro-op cache diagnostics optimized for AMD processors.
The diagnostics fill the µop cache with
...
Usage:
    python uop_cache-amd.py <bin_dir> <output_dir> <core_id>[,<sibling_core_id>]
...
if __name__ == "__main__":
    ...
    for diag in diag_list:
        ...
        # Note: Uses coreids[0] for the main diagnostic
